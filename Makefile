...
.PHONY: all dirs clean floppy asm gdb run debug viewlog minicom image pad-image run-net debug-net
...
pad-image: image
	@([ -f $(DIR_BUILD)/.padded ] && echo "Image already padded, skip.") || ( echo "Padding $(ELF_IMAGE) by 4 * 512MB..."; \
